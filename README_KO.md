...
### 8. Script.csv / Skit.csv / MapData.csv — Script.csv 번역 완료(2026-08-02), Skit/MapData는 주체 미정
...
- [ ] `Skit.csv`(34,255줄)/`MapData.csv`(3,153줄) 스킷·필드 대사 번역 — **2026-08-02부터 AI 전담으로 전환** (Script.csv와 동일 원칙 적용, 아직 미착수)
...
- [ ] Skit/MapData 번역이 채워진 뒤 동일한 recompile 파이프라인 검증 (아래 원칙 변경에 따라 AI가 번역 완료하는 대로 진행)
